...
const CreateAuthor = () => {
  ...
  const handleNameChange = (e) => {
    ...
    setFormData({
      ...formData,
      full_name: name,
      slug: formData.slug || generateSlug(name) // Auto-generate if slug is empty
    });
  };
  ...
  const checkSlugUniqueness = async (slug) => {
    ...
    try {
      ...
      const exists = response.data.some((author) => author.slug === slug);
      if (exists) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-cinzel font-bold text-gray-900">Add Team Member</h1>
          <p className="text-gray-600 mt-1">Create a new author profile for your team</p>
        </div>
      </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Upload a professional headshot (recommended: 400x400px)</p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <RichTextEditor
                ...
                placeholder="Write a comprehensive biography with background, expertise, and achievements..."
              />
              <p className="text-sm text-gray-500 mt-2">
                Write a detailed biography for the author's profile page
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <label htmlFor="featured" className="text-sm font-medium text-gray-700">
                Featured (show on homepage "Meet the Team" section)
              </label>
            </div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  maxLength={160}
                  placeholder="Meet John Smith, Credlocity's expert credit consultant with 10+ years experience..."
                />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-blue focus:border-transparent"
                  placeholder="credit consultant, credit repair expert, john smith"
                />
